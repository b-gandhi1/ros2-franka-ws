...
auto node = rclcpp::Node::make_shared("External_Torque_Node");
auto publisher_1 =
    node->create_publisher<std_msgs::msg::Float64MultiArray>("tau_ext_hat_filtered", 10);
auto publisher_2 =
    node->create_publisher<std_msgs::msg::Float64MultiArray>("O_F_ext_hat_K", 10);
...
hardware_interface::return_type FrankaHardwareInterface::read() {
  ...
  hw_extorque1_ = kState.tau_ext_hat_filtered;
  hw_extorque2_ = kState.O_F_ext_hat_K;

  auto message1 = std_msgs::msg::Float64MultiArray();
  message1.data.clear();
  message1.data.push_back(hw_extorque1_[0]);
  message1.data.push_back(hw_extorque1_[1]);
  message1.data.push_back(hw_extorque1_[2]);
  message1.data.push_back(hw_extorque1_[3]);
  message1.data.push_back(hw_extorque1_[4]);
  message1.data.push_back(hw_extorque1_[5]);
  message1.data.push_back(hw_extorque1_[6]);
  publisher_1->publish(message1);

  auto message2 = std_msgs::msg::Float64MultiArray();
  message2.data.clear();
  message2.data.push_back(hw_extorque2_[0]);
  message2.data.push_back(hw_extorque2_[1]);
  message2.data.push_back(hw_extorque2_[2]);
  message2.data.push_back(hw_extorque2_[3]);
  message2.data.push_back(hw_extorque2_[4]);
  message2.data.push_back(hw_extorque2_[5]);
